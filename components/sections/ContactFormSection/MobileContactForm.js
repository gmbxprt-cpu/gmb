        ...
        <div className="bg-white p-6 rounded-lg shadow-xl border-t-4 border-blue-600">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" name="name" id="name-mobile" required placeholder="e.g., John Doe" className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"/>
            </div>
            <div>
              <label htmlFor="email-mobile" className="block text-sm font-bold text-slate-700">Email</label>
              <input type="email" name="email" id="email-mobile" required placeholder="e.g., john@example.com" className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"/>
            </div>
            <div>
              <label htmlFor="contact-mobile" className="block text-sm font-bold text-slate-700">Contact Number</label>
              <input type="tel" name="contact" id="contact-mobile" required placeholder="Your contact number" className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"/>
            </div>
            <div>
              <label htmlFor="gmbLink-mobile" className="block text-sm font-bold text-slate-700">GMB Profile Link</label>
              <input type="url" name="gmbLink" id="gmbLink-mobile" required placeholder="Your GMB profile URL" className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"/>
            </div>
            <div>
              ...
              <select
                ...
                className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"
              >
            ...
            {showOther && (
              <div>
                ...
                <input type="text" name="other" id="other-mobile" required placeholder="Describe your requirement" className="mt-1 block w-full rounded-md border-slate-300 shadow-sm p-3"/>
              </div>
            )}
            ...
            <div className="flex justify-center">
              <ReCAPTCHA
                sitekey="6LfXe-srAAAAADRLcbRd6Pcb8DYvtP1WmCR-a8BN"
            ...
            <div>
              <button
                ...
                className="w-full justify-center rounded-md bg-gradient-to-r from-blue-600 to-indigo-600 py-3 px-4 text-white font-semibold hover:opacity-90 disabled:bg-slate-400 shadow-lg"
              >
