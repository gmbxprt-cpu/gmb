...
const OnetimeCard = ({ service, isFeatured = false }) => {
    const phoneNumber = "917009364216"; // Your WhatsApp number
    const whatsappMessage = `Hello GMB Expert, I am interested in the "${service.name}" onetime service priced at ₹${service.price.toLocaleString('en-IN')}.`;
            ...
            <div className="container mx-auto px-4 text-center">
                <Fade direction="up" cascade damping={0.1} triggerOnce>
                    ...
                    <div className="mt-12 flex flex-col items-center space-y-10">
                        ...
                        <OnetimeCard service={onetimeServicesData.newListing} isFeatured={true} /> {/* Making New Listing featured */}
