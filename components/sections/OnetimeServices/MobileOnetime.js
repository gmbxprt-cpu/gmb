...
const CheckIcon = () => <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>;
const CrossIcon = () => <svg className="w-5 h-5 text-slate-300 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" /></svg>;
...
// Ab component bahar se 'borderColorClass' lega
const OnetimeCard = ({ service, isFeatured = false, borderColorClass = 'border-slate-200' }) => {
    ...
    return (
        <div className={`bg-white rounded-2xl p-6 shadow-lg w-full relative border-2 ${borderColorClass} ${featuredClasses}`}>
            ...
            <p className="text-center mt-2">
                <span className="text-4xl font-extrabold text-black">₹{service.price.toLocaleString('en-IN')}</span>
            ...
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full mt-6 py-3 px-6 text-center rounded-lg font-semibold text-white bg-green-500 hover:bg-green-600 transition-colors duration-300">
        ...
        <section className="bg-white py-16 md:hidden">
            <div className="container mx-auto px-4 text-center">
                <Fade direction="up" cascade damping={0.1} triggerOnce>
                    ...
                    {/* --- CHANGE YAHAN KIYA GAYA HAI --- */}
                    {/* Har card ko apen aap color diya gaya hai */}
                    <div className="mt-12 flex flex-col items-center space-y-10">
                        <OnetimeCard service={onetimeServicesData.phoneVerification} borderColorClass="border-red-600" />
                        <OnetimeCard service={onetimeServicesData.newListing} isFeatured={true} borderColorClass="border-blue-600" />
                        <OnetimeCard service={onetimeServicesData.reinstatement} borderColorClass="border-green-600" />
                    </div>
                </Fade>
            </div>
        </section>
