...
// 👇 Animation waala part bilkul waise hi rakha gaya hai
...
export default function WhatsAppButtonPro({ 
  ...
  // 👇 Sirf yahan se message (text) wala part hataya gaya hai
  ...
  return (
    <>
      ...
      >
        ...
        {/* 👇 Animation class 'animate-pulse-slow' bhi waise hi hai */}
